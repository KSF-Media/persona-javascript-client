...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Persona.SubscriptionPauseEdit();
  });
  ...
  describe('SubscriptionPauseEdit', function() {
    it('should create an instance of SubscriptionPauseEdit', function() {
      // uncomment below and update the code to test SubscriptionPauseEdit
      //var instance = new Persona.SubscriptionPauseEdit();
      //expect(instance).to.be.a(Persona.SubscriptionPauseEdit);
    });
    ...
    it('should have the property oldEndDate (base name: "oldEndDate")', function() {
      // uncomment below and update the code to test the property oldEndDate
      //var instance = new Persona.SubscriptionPauseEdit();
      //expect(instance).to.be();
    });
