...
(function(root, factory) {
  ...
  describe('FaroUser', function() {
    it('should create an instance of FaroUser', function() {
      // uncomment below and update the code to test FaroUser
      //var instance = new Persona.FaroUser();
      //expect(instance).to.be.a(Persona.FaroUser);
    });
