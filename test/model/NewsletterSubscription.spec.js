...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Persona.NewsletterSubscription();
  });
  ...
  describe('NewsletterSubscription', function() {
    it('should create an instance of NewsletterSubscription', function() {
      // uncomment below and update the code to test NewsletterSubscription
      //var instance = new Persona.NewsletterSubscription();
      //expect(instance).to.be.a(Persona.NewsletterSubscription);
    });
