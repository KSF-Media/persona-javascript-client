...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Persona.PastTemporaryAddress();
  });
  ...
  describe('PastTemporaryAddress', function() {
    it('should create an instance of PastTemporaryAddress', function() {
      // uncomment below and update the code to test PastTemporaryAddress
      //var instance = new Persona.PastTemporaryAddress();
      //expect(instance).to.be.a(Persona.PastTemporaryAddress);
    });
