...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Persona.UpdatePasswordData();
  });
  ...
  describe('UpdatePasswordData', function() {
    it('should create an instance of UpdatePasswordData', function() {
      // uncomment below and update the code to test UpdatePasswordData
      //var instance = new Persona.UpdatePasswordData();
      //expect(instance).to.be.a(Persona.UpdatePasswordData);
    });
