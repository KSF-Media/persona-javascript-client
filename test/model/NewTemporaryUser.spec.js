...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Persona.NewTemporaryUser();
  });
  ...
  describe('NewTemporaryUser', function() {
    it('should create an instance of NewTemporaryUser', function() {
      // uncomment below and update the code to test NewTemporaryUser
      //var instance = new Persona.NewTemporaryUser();
      //expect(instance).to.be.a(Persona.NewTemporaryUser);
    });
