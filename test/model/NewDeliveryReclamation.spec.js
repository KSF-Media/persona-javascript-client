...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Persona.NewDeliveryReclamation();
  });
  ...
  describe('NewDeliveryReclamation', function() {
    it('should create an instance of NewDeliveryReclamation', function() {
      // uncomment below and update the code to test NewDeliveryReclamation
      //var instance = new Persona.NewDeliveryReclamation();
      //expect(instance).to.be.a(Persona.NewDeliveryReclamation);
    });
