...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Persona.FreePassInput();
  });
  ...
  describe('FreePassInput', function() {
    it('should create an instance of FreePassInput', function() {
      // uncomment below and update the code to test FreePassInput
      //var instance = new Persona.FreePassInput();
      //expect(instance).to.be.a(Persona.FreePassInput);
    });
