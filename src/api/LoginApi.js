...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LoginData', 'model/LoginDataSSO', 'model/LoginDataSoMe', 'model/LoginResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/LoginData'), require('../model/LoginDataSSO'), require('../model/LoginDataSoMe'), require('../model/LoginResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Persona) {
      root.Persona = {};
    }
    root.Persona.LoginApi = factory(root.Persona.ApiClient, root.Persona.LoginData, root.Persona.LoginDataSSO, root.Persona.LoginDataSoMe, root.Persona.LoginResponse);
  }
}(this, function(ApiClient, LoginData, LoginDataSSO, LoginDataSoMe, LoginResponse) {
  'use strict';
