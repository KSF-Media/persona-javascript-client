...
(function(factory) {
   ...
   * <pre>
   * var PersonaClient = require('index'); // See note below*.
   * var xxxSvc = new PersonaClient.XxxApi(); // Allocate the API class we're going to use.
   * var yyyModel = new PersonaClient.Yyy(); // Construct a model instance.
   ...
   * <pre>
   * var xxxSvc = new PersonaClient.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new PersonaClient.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
