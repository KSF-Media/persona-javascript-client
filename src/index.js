...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ActiveDays', 'model/Address', 'model/AdminNewUser', 'model/CancelSubscriptionReason', 'model/DeleteTempAddressChangeDates', 'model/DeliveryAddress', 'model/DeliveryReclamation', 'model/EntitlementAccess', 'model/FaroUser', 'model/FreePass', 'model/FreePassInput', 'model/GdprConsent', 'model/InlineResponse400', 'model/InlineResponse400InvalidRequestBody', 'model/InlineResponse403', 'model/InlineResponse4031', 'model/InlineResponse4031AccessTokenExpired', 'model/InlineResponse403InvalidCredentials', 'model/InlineResponse415', 'model/InlineResponse415UnsupportedMediaType', 'model/InlineResponse500', 'model/InlineResponse500InternalServerError', 'model/JanrainUser', 'model/LegalConsent', 'model/LoginData', 'model/LoginDataSSO', 'model/LoginResponse', 'model/ModelPackage', 'model/NewDeliveryReclamation', 'model/NewTemporaryUser', 'model/NewUser', 'model/Newsletter', 'model/NewsletterSubscription', 'model/PackageCampaign', 'model/PackageOffer', 'model/Paper', 'model/PastTemporaryAddress', 'model/PausedSubscription', 'model/Payment', 'model/PendingAddressChange', 'model/PersistedEntitlementAccess', 'model/Product', 'model/SearchQuery', 'model/SearchResult', 'model/Subscription', 'model/SubscriptionDates', 'model/SubscriptionPauseDates', 'model/SubscriptionPauseEdit', 'model/SubscriptionPayments', 'model/TemporaryAddressChange', 'model/TemporaryAddressChangeDates', 'model/User', 'model/UserUpdate', 'model/UserUpdateAddress', 'model/UserUpdatePassword', 'api/AdminApi', 'api/EntitlementsApi', 'api/IdentificationApi', 'api/LoginApi', 'api/UsersApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/ActiveDays'), require('./model/Address'), require('./model/AdminNewUser'), require('./model/CancelSubscriptionReason'), require('./model/DeleteTempAddressChangeDates'), require('./model/DeliveryAddress'), require('./model/DeliveryReclamation'), require('./model/EntitlementAccess'), require('./model/FaroUser'), require('./model/FreePass'), require('./model/FreePassInput'), require('./model/GdprConsent'), require('./model/InlineResponse400'), require('./model/InlineResponse400InvalidRequestBody'), require('./model/InlineResponse403'), require('./model/InlineResponse4031'), require('./model/InlineResponse4031AccessTokenExpired'), require('./model/InlineResponse403InvalidCredentials'), require('./model/InlineResponse415'), require('./model/InlineResponse415UnsupportedMediaType'), require('./model/InlineResponse500'), require('./model/InlineResponse500InternalServerError'), require('./model/JanrainUser'), require('./model/LegalConsent'), require('./model/LoginData'), require('./model/LoginDataSSO'), require('./model/LoginResponse'), require('./model/ModelPackage'), require('./model/NewDeliveryReclamation'), require('./model/NewTemporaryUser'), require('./model/NewUser'), require('./model/Newsletter'), require('./model/NewsletterSubscription'), require('./model/PackageCampaign'), require('./model/PackageOffer'), require('./model/Paper'), require('./model/PastTemporaryAddress'), require('./model/PausedSubscription'), require('./model/Payment'), require('./model/PendingAddressChange'), require('./model/PersistedEntitlementAccess'), require('./model/Product'), require('./model/SearchQuery'), require('./model/SearchResult'), require('./model/Subscription'), require('./model/SubscriptionDates'), require('./model/SubscriptionPauseDates'), require('./model/SubscriptionPauseEdit'), require('./model/SubscriptionPayments'), require('./model/TemporaryAddressChange'), require('./model/TemporaryAddressChangeDates'), require('./model/User'), require('./model/UserUpdate'), require('./model/UserUpdateAddress'), require('./model/UserUpdatePassword'), require('./api/AdminApi'), require('./api/EntitlementsApi'), require('./api/IdentificationApi'), require('./api/LoginApi'), require('./api/UsersApi'));
  }
}(function(ApiClient, ActiveDays, Address, AdminNewUser, CancelSubscriptionReason, DeleteTempAddressChangeDates, DeliveryAddress, DeliveryReclamation, EntitlementAccess, FaroUser, FreePass, FreePassInput, GdprConsent, InlineResponse400, InlineResponse400InvalidRequestBody, InlineResponse403, InlineResponse4031, InlineResponse4031AccessTokenExpired, InlineResponse403InvalidCredentials, InlineResponse415, InlineResponse415UnsupportedMediaType, InlineResponse500, InlineResponse500InternalServerError, JanrainUser, LegalConsent, LoginData, LoginDataSSO, LoginResponse, ModelPackage, NewDeliveryReclamation, NewTemporaryUser, NewUser, Newsletter, NewsletterSubscription, PackageCampaign, PackageOffer, Paper, PastTemporaryAddress, PausedSubscription, Payment, PendingAddressChange, PersistedEntitlementAccess, Product, SearchQuery, SearchResult, Subscription, SubscriptionDates, SubscriptionPauseDates, SubscriptionPauseEdit, SubscriptionPayments, TemporaryAddressChange, TemporaryAddressChangeDates, User, UserUpdate, UserUpdateAddress, UserUpdatePassword, AdminApi, EntitlementsApi, IdentificationApi, LoginApi, UsersApi) {
  'use strict';
  ...
  var exports = {
    ...
    FaroUser: FaroUser,
    /**
     * The FreePass model constructor.
     * @property {module:model/FreePass}
     */
    FreePass: FreePass,
    /**
     * The FreePassInput model constructor.
     * @property {module:model/FreePassInput}
     */
    FreePassInput: FreePassInput,
    /**
